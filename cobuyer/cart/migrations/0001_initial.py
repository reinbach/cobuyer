...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cart_cart', (
            ('id', orm['cart.Cart:id']),
            ('user', orm['cart.Cart:user']),
            ('completed', orm['cart.Cart:completed']),
            ('created', orm['cart.Cart:created']),
            ('modified', orm['cart.Cart:modified']),
        ))
        ...
        db.create_table('cart_item', (
            ('id', orm['cart.Item:id']),
            ('cart', orm['cart.Item:cart']),
            ('product', orm['cart.Item:product']),
            ('description', orm['cart.Item:description']),
            ('size', orm['cart.Item:size']),
            ('quantity', orm['cart.Item:quantity']),
            ('unit_price', orm['cart.Item:unit_price']),
            ('created', orm['cart.Item:created']),
            ('modified', orm['cart.Item:modified']),
        ))
